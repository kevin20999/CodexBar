...
public struct OpenAIDashboardSnapshot: Codable, Equatable, Sendable {
    ...
    public let sparkPrimaryLimit: RateWindow?
    public let sparkSecondaryLimit: RateWindow?
        ...
        updatedAt: Date)
    {
        ...
        self.sparkPrimaryLimit = sparkPrimaryLimit
        self.sparkSecondaryLimit = sparkSecondaryLimit
    ...
    private enum CodingKeys: String, CodingKey {
        ...
        case primaryLimit
        case secondaryLimit
        case sparkPrimaryLimit
        case sparkSecondaryLimit
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.sparkPrimaryLimit = try container.decodeIfPresent(RateWindow.self, forKey: .sparkPrimaryLimit)
        self.sparkSecondaryLimit = try container.decodeIfPresent(RateWindow.self, forKey: .sparkSecondaryLimit)
...
public enum OpenAIDashboardCacheStore {
    ...
    private static var cacheURL: URL? {
        ...
        let dir = root.appendingPathComponent(TokenAppIdentity.applicationSupportDirectoryName, isDirectory: true)
        return dir.appendingPathComponent("openai_dashboard.json")
    }
}
