...
public struct OpenAIDashboardFetcher {
    public nonisolated static let usagePageURL = URL(string: "https://chatgpt.com/codex/settings/usage")!
    ...
    private let usageURL = Self.usagePageURL
        ...
        timeout: TimeInterval = 60) async throws -> OpenAIDashboardSnapshot
    {
        ...
        while Date() < deadline {
            ...
            let rateLimits = OpenAIDashboardParser.parseGroupedRateLimits(bodyText: bodyText)
            ...
            let hasUsageLimits = rateLimits.primary != nil
                || rateLimits.secondary != nil
                || rateLimits.sparkPrimary != nil
                || rateLimits.sparkSecondary != nil
                ...
                .isEmpty || hasUsageLimits || creditsRemaining != nil
            {
                ...
                return OpenAIDashboardSnapshot(
                    ...
                    sparkPrimaryLimit: rateLimits.sparkPrimary,
                    sparkSecondaryLimit: rateLimits.sparkSecondary,
